...
//
//  myCar.setColor("black");System.out.println(myCar.getColor());
//
...
//  int i = A.compareTo(B);if(i>0)
//  {// if statement if i is greater than zero print yes
//    System.out.println("Yes");
//  }else
//  {// else statement if its not true prints out no
//   System.out.println("No");
//  }
//  String a = A.substring(0, 1).toUpperCase() + A.substring(1);
//  String b = B.substring(0, 1).toUpperCase() + B.substring(1);;System.out.println(a+" "+b);
//  Scanner scan = new Scanner(System.in);System.out.println("Enter Integer");
//  int a = scan.nextInt();System.out.println("Enter a Double:");
//  double b = scan.nextDouble();scan.nextLine();// when going from numbers to string, clear out
//                                               // buffer.
// System.out.println("Enter a String:");
//  String c = scan.nextLine();System.out.println(a);// prints out int a, a integer
...
//  System.out.println(greeting);// prints out the input
  /*
   * variable or an object or an integer being declared. scope is a variable accessible in area its
   * declared. final variable is a variable that can't be changed Casting is going from one data
   * type to another ctrl shift f- automatic format
   */
